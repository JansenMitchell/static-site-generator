...
def create_html_node_for_block(block):
    ...
    # TODO: Correct node types (Parent or Leaf)
    if block_type == BlockType.HEADING:
        ...
        return ParentNode(tag="pre", children=[HTMLNode(tag="code", children=[code_content])])
